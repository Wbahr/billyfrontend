            ...
            <Container>
                ...
                <DetailDiv>
                    <Div>
                        ...
                        <ProductLayout
                            text={(
                                <div> When you need to boost the pressure of compressed air, liquids or gasses (such as hydrogen, oxygen or argon), Airline is your trusted source. We provide custom-designed Haskel pressure systems for a wide range of applications. Airline engineers will custom design and build turnkey booster packages including the following integrated components:
                                    <ul>
