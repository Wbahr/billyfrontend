...
export function ShipToForm(props) {
	...
	function handleSavedAddressSelectChange(name, value){
		if(value !== -1){
			...
			setFieldValue('shipto.country', quoteDropdownData.shipToAddresses[index].physCountry.toLowerCase())
			setFieldValue('shipto.companyName', quoteDropdownData.shipToAddresses[index].companyName)
			setFieldValue('shipto.address1', quoteDropdownData.shipToAddresses[index].physAddress1)
			setFieldValue('shipto.address2', quoteDropdownData.shipToAddresses[index].physAddress2)
			setFieldValue('shipto.city', quoteDropdownData.shipToAddresses[index].physCity)
			setFieldValue('shipto.stateOrProvince', quoteDropdownData.shipToAddresses[index].physState)
			setFieldValue('shipto.zip', quoteDropdownData.shipToAddresses[index].physPostalCode)
