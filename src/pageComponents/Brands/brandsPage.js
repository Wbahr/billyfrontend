    ...
    return (
        <Container>
            ...
            <ProductDiv>
                <CompanyListDiv>
                    <Ul>
                        <Li><CompanyList href="http://www.bijurdelimon.com/" target="_blank">Bijur Delimon</CompanyList> - Automatic Centralized Grease and Oil Systems, Farval Dualine Systems, Open Gear Spray Systems, Air/Oil Systems, Programmable Controllers and Monitoring Equipment. </Li>
                        <Li><CompanyList href="http://www.lincolnindustrial.com/" target="_blank">Lincoln Lubrication</CompanyList> - Automated Lubrication Systems, Orsco Chain Lube Systems, Construction & Mobile Vehicle Lube Systems & Lubrication Components</Li>
                    </Ul>
                </CompanyListDiv>
                <CompanyListDiv>
                    <Ul>
                        <Li><CompanyList href="http://www.skf.com/lubrication" target="_blank">SKF</CompanyList> - Automated Lubrication Systems, Circulating Oil Systems, Oil & Air Lubrication Systems, Lubrication Systems for Special Applications, Construction & Mobile Vehicle Lube Systems & Lubrication Components</Li>
                    </Ul>
                </CompanyListDiv>
            </ProductDiv>
            <CategoryDiv>
            ...
            <ProductDiv>
                <CompanyListDiv>
                    <Ul>
                        <Li><CompanyList href="http://www.boschrexroth-us.com/" target="_blank">Bosch Rexroth </CompanyList> - Aluminum Structural Framing & Accessories Industrial Hand Tools & Tightening Systems</Li>
            ...
            <ProductDiv>
                <CompanyListDiv>
                    <Ul>
                        ...
                        <Li><CompanyList href="http://www.bannerengineering.com/" target="_blank">Banner Engineering</CompanyList> - Photoelectric Sensors, Fiber Optic Sensors, Wireless I/O, Vision Inspection Sensors, LED Lighting & Indication</Li>
                        <Li><CompanyList href="http://www.beijerelectronics.com/" target="_blank">Beijer</CompanyList>  - HMIs & Industrial PCs</Li>
                        <Li><CompanyList href="http://www.boschrexroth-us.com/" target="_blank">Bosch Rexroth Control</CompanyList>- Rotary & Linear Servo Motors & Drives, Integrated Motor/Drive, Motion Controllers, HMIs, Integrated Safety, I/O, Explosion-Proof Motors, Industrial Hand Tools & Tightening Systems</Li>
                        <Li><CompanyList href="http://www.boschrexroth-us.com/" target="_blank">Bosch Rexroth Linear</CompanyList> - Ball/Roller Rail, Ball/Roller Screws, Linear Modules, Cartesian Systems, Conveyor Systems, Round Shafting & Bushings</Li>
                        ...
                        <Li><CompanyList href="http://www.eaton.com/" target="_blank">Eaton</CompanyList> - VFDs, PLCs, HMIs, HMIs with Control, Industrial PCs, Remote I/O & Connectivity, Control Wiring Solutions, Proximity & Photo Sensors, Limit Switches, Energy Monitors</Li>
                        ...
                        <Li><CompanyList href="http://www.gamweb.com/" target="_blank">GAM</CompanyList> - Gearboxes, Servo Couplings, Mounting Accessories</Li>
                ...
                <CompanyListDiv>
                    <Ul>
                        ...
                        <Li><CompanyList href="https://automation.omron.com/en/us/" target="_blank">Omron</CompanyList> - Temperature & Process Controllers, Servo Drives & Motors, VFDs, Photo & Proximity Sensors, Machine Automation Controllers & PLCs, Remote I/O, HMIs, Industrial PCs, Vision & Identification Sensors & Systems, Laser Marking</Li>
                        ...
                        <Li><CompanyList href="http://www.orientalmotor.com/" target="_blank">Oriental Motor</CompanyList> - Stepper Motors & Drives (2 and 5 Phase), Closed Loop Steppers, AC/DC Fractional HP Motors & Drives, Electro-Mechanical Actuators, Fans</Li>
                        <Li><CompanyList href="http://www.pepperl-fuchs.us/" target="_blank">Pepperl + Fuchs</CompanyList> - Industrial Sensors, RFID Systems, Encoders, AS-Interface Solutions</Li>
                        <Li><CompanyList href="http://www.phoenixcontact.com/us" target="_blank">Phoenix Contact</CompanyList> - Wireless I/O & Networking, IP20 & IP67 Remote I/O, HMIs, Industrial PCs, PLCs & Programmable Relays, Ethernet & Fieldbus Cabling/Infrastructure, IIoT Solutions</Li>
            ...
            <ProductDiv>
                <CompanyListDiv>
                    <Ul>
                        ...
                        <Li><CompanyList href="https://www.hammfg.com/" target="_blank">Hammond Manufacturing</CompanyList> - Industrial & IT Enclosures, Heating Products, Fans, Coolers</Li>
                        <Li><CompanyList href="http://www.hammondpowersolutions.com/" target="_blank">Hammond Power Solutions </CompanyList> - Reactors, Transformers, Power Distribution & Busbar</Li>
                ...
                <CompanyListDiv>
                    <Ul>
                        ...
                        <Li><CompanyList href="https://automation.omron.com/en/us/" target="_blank">Omron</CompanyList> - Relays, Power Supplies, Limit Switches, Timers, Counters</Li>
            ...
            <ProductDiv>
                <CompanyListDiv>
                    <Ul>
                        ...
                        <Li><CompanyList href="http://www.haskel.com/" target="_blank">Haskel </CompanyList> - Air & Hydraulic-Driven Gas Boosters, Air-Driven Liquid Pumps & Amplifiers, Pressure Systems, Accessories, Low, Medium & High Pressure Valves</Li>
                    </Ul>
                </CompanyListDiv>
                <CompanyListDiv>
                    <Ul>
                        <Li><CompanyList href="http://www.smcusa.com/" target="_blank">SMC</CompanyList> - Air Pressure Amplifiers, High-Pressure Regulators, High-Purity Filters, Cryogenic Valves, Liquid Solenoid Pumps, AP Tech Regulator</Li>
                    </Ul>
                </CompanyListDiv>
            </ProductDiv>
            <CategoryDiv>
